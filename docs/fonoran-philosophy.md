# Fonoran Philosophy & Design Rationale

> **Read the [Constitution](fonoran-constitution.md) first.** This document is extended
> rationale — why Fonoran is designed this way and how we judge success. For syntax see
> [fonoran-grammar.md](fonoran-grammar.md). For the research narrative see
...
- [fonoran-constitution.md](fonoran-constitution.md) — the founding document (read first)
