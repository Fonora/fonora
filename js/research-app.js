    ...
    <article class="research-page content-page">
      ...
      <section class="research-open-threads" aria-label="Outstanding threads">
        ...
        <ul class="research-thread-list">
          ...
          <li><strong>Learner signal</strong> — first Translator/Dictionary results after regen; playtests ongoing (<a href="${escapeHtml(researchHref('phase-iv-first-learner-signal'))}">RN-19</a>, draft).</li>
