...
import {
  ...
  sortTimeSlotConcepts,
} from './fonoran-frame-grammar.js';

// Frame grammar lives outside the quarantine: the deterministic engine applies the same
// rules and may not import an LLM module to do it.
export { applyDisjunction, promoteTemporalSceneToTime, sortTimeSlotConcepts };
