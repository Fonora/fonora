...
export const ASSOCIATION_SEEDS = {
  ...
  break: [['conflict', 'thing'], ['thing', 'conflict'], ['conflict', 'bound']],
  ...
  cut: [['bound', 'make'], ['stone', 'bound'], ['conflict', 'bound']],
  ...
  floor: [['earth', 'inside'], ['earth', 'bound'], ['inside', 'bound', 'earth']],
  ...
  imagine: [['think', 'make'], ['make', 'think'], ['think', 'inside']],
  ...
  plank: [['plant', 'stone'], ['plant', 'bound'], ['make', 'plant']],
  ...
  rope: [['plant', 'bond'], ['bound', 'plant'], ['hold', 'plant']],
  ...
  tie: [['bond', 'hand'], ['hand', 'bond'], ['hold', 'bound']],
